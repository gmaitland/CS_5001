"""
    ...
    CS 5001
    11/19/2023
    Align Online Module 7 - dictionary_example.py
"""

"""
    Used a dictionary to implement a phone book. The phone book is able to
    to save and print the name and contacts. Key errors are common in dictionaries.
...
def remove(name):
    """
        ...
        Returns True if the name was successfully removed, false otherwise
    """
    if name in contacts:
        del contacts[name]
        return True
